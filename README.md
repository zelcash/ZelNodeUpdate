...
Some users that have not updated in a long time might see the following. Select the "Keep the local version currently installed" option. This is because the script is updating the OS with latest security and bug patches to Linux.
